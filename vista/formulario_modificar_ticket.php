    ...
    <form method="post" action="">
        <section class="datos_ticket_1">
            <div class="row">
                ...
                <div class="col"><input type="number" name="id_ticket" id="id_ticket" required list="lista_id_tick_mod">
            ...
            <div class="row">
                ...
                <div class="col"><input type="text" name="nombres_usuario" id="nombres_usuario" required disabled></div>
            </div>
            <div class="row">

                <div class="col"><p>Apellidos</p></div>
                <div class="col"><input type="text" name="apellidos_usuario" id="apellidos_usuario" required disabled></div>
                <div class="col"><p>Ciudad</p></div>
                <div class="col"><input type="text" name="ciudad_usuario" id="ciudad_usuario" required disabled></div>
            </div>
            <div class="row">
                <div class="col"><p>Telefono</p></div>
                <div class="col"><input type="text" name="telefono_usuario" id="telefono_usuario" required disabled></div>
                <div class="col"><p>Correo</p></div>
                <div class="col"><input type="text" name="correo_usuario"id="corre_usuario" required disabled></div>
            </div>
        </section>
        <section class="datos_ticket_2">
            ...
            <div class="row">
                <div class="col"> <textarea type="number" disabled name="telefono" class="observacion" ></textarea></div>
            </div>
